...
public class BlockchainContextBuilderWithMemory implements BlockchainContextBuilder {
    ...
    public BlockchainContextBuilderWithMemory(
    ...
    public BlockchainContext build() throws ErgoClientException {
        ...
        return new BlockchainContextWithMemory(_client, _retrofit, _explorer, _retrofitExplorer, _networkType, _nodeInfo, _headers);
    }
