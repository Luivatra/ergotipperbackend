...
public class TransactionInfo {
  ...
  **/
  ...
  public TransactionInfo globalIndex(Long globalIndex) {
   ...
   * @return globalIndex
  **/
  @Schema(required = true, description = "global index of a transaction in the blockchain")
  ...
  **/
  ...
  public TransactionInfo inputs(List<InputInfo> inputs) {
    this.inputs = inputs;
    return this;
  }
  ...
  **/
  ...
  public TransactionInfo dataInputs(List<DataInputInfo> dataInputs) {
  ...
  **/
  ...
  public void setDataInputs(List<DataInputInfo> dataInputs) {
    this.dataInputs = dataInputs;
  }

  public TransactionInfo outputs(List<OutputInfo> outputs) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, transactionInfo.id) &&
        ...
        Objects.equals(this.globalIndex, transactionInfo.globalIndex) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, blockId, inclusionHeight, timestamp, index, globalIndex, numConfirmations, inputs, dataInputs, outputs, size);
  }
